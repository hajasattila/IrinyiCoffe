...
<div class="main-content anim">
    ...
    if (isset($_POST['delete-comment']) && isset($_SESSION['username'])) {
    ...
    if (isset($_POST['delete-comment']) || (isset($_SESSION['username']) && $_SESSION['username'] === 'admin')) {
    ...
    <div class="container">
        ...
        <?php } else { ?>
            <p>Kérlek jelentkezz be, hogy véleményt írhass!</p>
        <?php } ?>
        <ul class="posts">
            <?php

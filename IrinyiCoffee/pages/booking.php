    ...
    <main>
        <div class="main-content anim">
            ...
            <form method="post">
                ...
                <input type="text" id="name" name="name" placeholder="Minta Péter"
                    value="<?php echo $_SESSION["username"] ?>" disabled><br>
                ...
                <input type="number" id="people" name="people" min="1" max="10" placeholder="1-10" value="2"
                    required><br>
                ...
                <fieldset>
                    ...
                    <textarea id="comments" name="comments" placeholder="Megjegyzés..."
